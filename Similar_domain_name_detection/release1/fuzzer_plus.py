...
from release1.dependent_function import save_domains
        ...
        for f_name in fuzzers:
            try:
                ...
                for domain in self.domains:  # 添加代码
                    self.domains_tld.append(Permutation(fuzzer='none',
                                                        domain='.'.join(
...
if __name__ == '__main__':
    args = {
        ...
        'tld_all': True,
        'fuzzers': [
            #         'bitsquatting', 'vowel-swap', 'cyrillic', 'homoglyph', 'repetition','various', 'replacement','insertion',
            # 'addition',
            'hyphenation',
            # 'omission',
            # 'subdomain',
    ...
    # print(domains)
    save_domains(domains, "{} 3 相似域名".format(url.domain))
