...
def fatch_data_from_db(snum=1000, lnum=1000):
    import pymongo
...
def create_table_header():
    ...
    col_names = ["task_url", "fuzzer_num", 'similar_domain_num', "total_time", "domain"]
...
if __name__ == '__main__':
    # test_list = fatch_data_from_db(snum=0, lnum=1000)
    ...
    for i in test_list:
        print("\n>>>[start]>>> ", i)
        os.system("python name_exist.py {}".format(i))
